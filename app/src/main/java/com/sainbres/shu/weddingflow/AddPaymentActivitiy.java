...
public class AddPaymentActivitiy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_payment_activitiy);

        Toolbar toolbar = findViewById(R.id.addPayment_Toolbar);
        ...
        final Button addPaymentBtn = findViewById(R.id.addPaymentBtn);
        ...
        dateInput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(AddPaymentActivitiy.this,
